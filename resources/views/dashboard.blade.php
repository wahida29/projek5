...
@section('content')
    {{-- Hero Section --}}
    <div class="relative flex items-center justify-center h-screen bg-center bg-cover"
         style="background-image: url('/img/krusit2.png');">
        ...
        <div class="relative z-10 px-4 text-center text-white">
            ...
            <div class="mt-8">
                <a href="{{ url('/menu') }}"
                   class="px-6 py-3 text-lg font-semibold text-white transition bg-orange-500 rounded-full shadow-lg hover:bg-orange-600">
                    Pesan Sekarang
                </a>
            </div>
        </div>
