<footer class="text-gray-300 bg-gray-900">
    <div class="container px-4 py-8 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
        <h3 class="text-2xl font-semibold text-white">Krusit</h3>
        <p class="max-w-md mx-auto mt-2 text-sm">
            Solusi kreatif untuk berbagi ide dan inovasi digital dalam setiap gigitan krupuk pangsit goreng.
        </p>
        ...
        <p class="mt-6 text-xs text-gray-500">&copy; {{ date('Y') }} Krusit. All rights reserved.</p>
    </div>
</footer>
